...
The switch architecture declarations from [`very_simple_model.p4`](https://github.com/p4lang/p4c/blob/main/testdata/p4_16_samples/very_simple_model.p4) - typedefs, constants, struct definitions, parser/control/package type declarations, and the `Ck16` extern.
